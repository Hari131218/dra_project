...
import 'package:dra_project/screens/second_screen.dart';
                              ...
                              child: Row(
                                children: [
                                    ...
                                    child: TextField(
                                      ...
                                      onChanged: (content){
                                        ...
                                        if(content.length > 1){
                                          ...
                                          Provider.of<AssessorProvider>(context,listen: false).getSubmitedBasedOnDate("search","$content");
                                          defaultdate = false;
                                  ...
                                  _hasText ? GestureDetector(onTap:(){
                                    ...
                                    Provider.of<AssessorProvider>(context, listen: false).getSubmittedAssessment();
                                  },child:
                                  Icon(Icons.cancel,
                                    color: Colors.black87,
